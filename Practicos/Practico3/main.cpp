...
int main(int argc, char** argv){
    ...
    // Aumentamos el numero de parametros con el fin de simplificar la generacion de pruebas
    // El 1º parametro es para la ruta de la img de entrada
    // El 2º parametro es para saber por que potencia de 2 se divide la img para procesar
    // El 3º parametro es para elegir el algoritmo a utilizar

    // Puede mirar ejemplo de su ejecucion en el launch_all_practico3.sh
    ...
    char salida[30];
    sprintf(salida, "output_brillo_%d.pmm",algorithm);
   	image_out.save(salida);
